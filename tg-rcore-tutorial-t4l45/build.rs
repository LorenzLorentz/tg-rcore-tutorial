...
fn main() {
    ...
    println!("cargo:rerun-if-env-changed=T4L45_SCENARIO");
    println!("cargo:rerun-if-env-changed=T4L45_SCHED");
    println!("cargo:rerun-if-env-changed=T4L45_TRACE");
    println!("cargo:rerun-if-env-changed=T4L45_FAULT_MODE");
