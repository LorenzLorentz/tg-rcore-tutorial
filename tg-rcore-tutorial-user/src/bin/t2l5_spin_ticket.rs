...
use alloc::vec::Vec;
use user_lib::{
    AtomicStats, TicketSpinLock, busy_spin, exit, kernel_metrics, now_us, reset_kernel_metrics,
    sched_yield, thread_create, waittid,
};
...
pub extern "C" fn main() -> i32 {
    ...
    println!(
        "[t2l5-summary] primitive=spinlock variant=ticket ops={} contention={} avg_wait_us={} max_wait_us={} avg_hold_us={} max_hold_us={} ctx_switches={} blocked={} wakeups={} starvation={} bug_total={} bug_exact={} bug_heuristic={} bug_statistical={}",
    ...
    println!("t2l5 spin ticket passed!");
    0
}
